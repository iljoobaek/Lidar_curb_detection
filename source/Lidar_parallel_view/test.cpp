...
void trackerInit(Boundary_detection &detection, std::vector<std::vector<cv::Vec3f>> &linePoints, PyObject &pFunc,
            ...
            cv::viz::WPolyLine &prev_rline, std::vector<float> &prev_rcoeff, std::vector<cv::viz::WPolyLine> &thirdOrder){
...
//     Boundary_detection detection(64, 1.125, "/home/rtml/LiDAR_camera_calibration_work/data/kitti_data/2011_09_26/", "2011_09_26_drive_0051_sync/", frameStart, frameEnd+1, false);
    ...
    std::cout<<"DebugSeg\n";
    // Location for storing prev lines :: Tracker
...
//         }
        ...
        trackerInit(detection, linePoints, prev_avail_lcoeff, prev_lline, prev_lcoeff, prev_avail_rcoeff, prev_rline, 
                    prev_rcoeff, thirdOrder);
...
// 		std::vector<cv::viz::WPolyLine> gtLines = thirdOrder;
		...
		LidarViewer::updateViewerFromBuffers(buffers, results, viewer, res.first, thirdOrder,gtLines,  temp[0], temp[1],cvUltrasonicPoints);
